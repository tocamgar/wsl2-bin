...
logo="/mnt/e/Pictures/logo-cam_53x26_50a.png" # RUTA COMPLETA DE LA MARCA DE AGUA A INCRUSTAR
v_salida="${ruta}${nom_f}_h264_288p_crf30_aac_q1_ac1_01${ext_f}" # RUTA COMPLETA DEL VIDEO DE SALIDA
